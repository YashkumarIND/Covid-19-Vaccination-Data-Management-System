<?php 
    include "vaccination_org_view_logic.php";
...
<head>
    ...
    <title>Vaccinated Citizens View</title>
</head>
<body>
<form method="POST" action="vacc_citizens_search_page.php"> 
      <div class="p-8">
      ...
      <table class="table-auto w-full text-left whitespace-no-wrap">
        <thead>
          <tr>
            ...
            <th class="px-4 py-3 title-font tracking-wider font-medium text-white text-sm bg-gray-800">Vaccination ID</th>
            <th class="px-4 py-3 title-font tracking-wider font-medium text-white text-sm bg-gray-800">Date of Vaccination</th>
            <th class="px-4 py-3 title-font tracking-wider font-medium text-white text-sm bg-gray-800">Past Record</th>
