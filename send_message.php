<?php
  ...
  include "send_message_logic.php"
...
<head>
    ...
    <title>Hospital to Organization</title>
</head>
<body>
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center">
      ...
      <form method="POST">
          ...
          <p>
          <button name="send" class="flex mx-auto mt-16 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg" href="message_htp.php">Send</button>
          </p>
      </form>
