...
<head>
    ...
    <title>Vaccination Search</title>
</head>
<body>
                ...
                <div class="container px-5 py-24 mx-auto">
                    ...
                    <div class="card">
                        <div class="lg:w-2/3 w-full mx-auto overflow-auto">
                            ...
                            <thead>
                                <tr>
                                    <th class="px-4 py-3 title-font tracking-wider font-medium text-white text-sm bg-gray-800 rounded-tl rounded-bl">Vaccinated ID</th>
